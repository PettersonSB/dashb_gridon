-- Migration para Criação de Produtos e Itens de Kits Fotovoltaicos
-- Executar no Supabase SQL Editor

-- 1. Criação da Tabela de Produtos Reais
CREATE TABLE IF NOT EXISTS solar_products (
    ...
    model TEXT,
    power NUMERIC NOT NULL DEFAULT 0, -- Potência em Watts
    voltage TEXT,
    warranty INTEGER, -- Em anos
    image_url TEXT,
...
-- 2. Atualização na Tabela de Kits
...
-- Políticas RLS para Itens do Kit
